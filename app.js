    ...
    img.onload = function () {
        ...
        if (logoGroup) {
            ...
            if (modelo === 'especialidade_sp') {
                ...
                xPos = canvas.width * 0.86;
                yPos = canvas.height * 0.46;
            } 
            else if (modelo === 'progressao_l' || modelo === 'progressao_s' || modelo === 'progressao_p' || modelo === `progressao_e`) {
